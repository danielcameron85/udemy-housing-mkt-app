    ...
    <footer className='navbar'>
      <nav className="navbarNav">
            <ul className="navbarListItems">
                  ...
                  <li className="navbarListItem">
                        <PersonOutline fill={pathMatchRoute('/sign-in') ? '#2c2c2c' : '#8f8f8f'} width='36px' height='36px'  onClick={() => navigate('/sign-in')}/>
                        <p className={pathMatchRoute('/sign-in') ? 'navbarListItemNameActive' : 'navbarListItemName'}>Sign In</p>
                  </li>
                  <li className="navbarListItem">
                        <PersonOutline fill={pathMatchRoute('/profile') ? '#2c2c2c' : '#8f8f8f'} width='36px' height='36px'  onClick={() => navigate('/profile')}/>
